...
if TYPE_CHECKING:
    ...
    from itak.hooks.tool_hooks import ToolCallHookContext
...
def before_llm_call(
    ...
    *,
    ...
    """
    from itak.hooks.llm_hooks import register_before_llm_call_hook
    ...
    Example:
        ...
        With agent filter::
            ...
            def log_researcher_responses(context):
                ...
                return None
    """
    from itak.hooks.llm_hooks import register_after_llm_call_hook
...
def before_tool_call(
    ...
    *,
    ...
    """
    from itak.hooks.tool_hooks import register_before_tool_call_hook
    ...
    Example:
        ...
        With tool filter::
            ...
            def sanitize_search_results(context):
                ...
                return None
    """
    from itak.hooks.tool_hooks import register_after_tool_call_hook
