"""OpenAI agents adapter for iTaK integration.

This module contains the OpenAIAgentAdapter class that integrates OpenAI Assistants
with iTaK's agent system, providing tool integration and structured output support.
"""
...
from itak.agents.agent_adapters.openai_agents.openai_agent_tool_adapter import (
    OpenAIAgentToolAdapter,
)
from itak.agents.agent_adapters.openai_agents.protocols import (
    AgentKwargs,
    OpenAIAgent as OpenAIAgentProtocol,
    OpenAIAgentsModule,
)
from itak.agents.agent_adapters.openai_agents.structured_output_converter import (
...
class OpenAIAgentAdapter(BaseAgentAdapter):
    ...
    Integrates OpenAI Assistants API with iTaK's agent system, providing
