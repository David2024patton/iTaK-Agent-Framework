"""OpenAI agent tool adapter for iTaK tool integration.

This module contains the OpenAIAgentToolAdapter class that converts iTaK tools
...
from itak.agents.agent_adapters.base_tool_adapter import BaseToolAdapter
...
class OpenAIAgentToolAdapter(BaseToolAdapter):
    ...
    Converts iTaK BaseTool instances to OpenAI Assistant FunctionTool format
    ...
    def __init__(self, tools: list[BaseTool] | None = None) -> None:
        ...
        Args:
            tools: Optional list of iTaK tools to adapt.
        """
        super().__init__()
    ...
    def configure_tools(self, tools: list[BaseTool]) -> None:
        ...
        Args:
            tools: List of iTaK tools to configure.
        """
    ...
    def _convert_tools_to_openai_format(
        ...
        """Convert iTaK tools to OpenAI Assistant tool format.

        Args:
            tools: List of iTaK tools to convert.
        ...
        def create_tool_wrapper(tool: BaseTool) -> Any:
            ...
            async def wrapper(context_wrapper: Any, arguments: Any) -> Any:
                """Wrapper function to adapt iTaK tool calls to OpenAI format.
