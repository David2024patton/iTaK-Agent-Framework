"""LangGraph agent adapter for iTaK integration.

This module contains the LangGraphAgentAdapter class that integrates LangGraph ReAct agents
with iTaK's agent system. Provides memory persistence, tool integration, and structured
...
from itak.agents.agent_adapters.base_agent_adapter import BaseAgentAdapter
from itak.agents.agent_adapters.langgraph.langgraph_tool_adapter import (
    LangGraphToolAdapter,
)
from itak.agents.agent_adapters.langgraph.protocols import (
    LangGraphCheckPointMemoryModule,
    LangGraphPrebuiltModule,
)
from itak.agents.agent_adapters.langgraph.structured_output_converter import (
...
from itak.utilities.import_utils import require


class LangGraphAgentAdapter(BaseAgentAdapter):
    """Adapter for LangGraph agents to work with iTaK.

    This adapter integrates LangGraph's ReAct agents with iTaK's agent system,
