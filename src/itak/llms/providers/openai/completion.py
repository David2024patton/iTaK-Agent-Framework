...
from itak.events.types.llm_events import LLMCallType
from itak.llms.base_llm import BaseLLM
from itak.llms.hooks.transport import AsyncHTTPTransport, HTTPTransport
from itak.utilities.agent_utils import is_context_length_exceeded
from itak.utilities.exceptions.context_window_exceeding_exception import (
    LLMContextLengthExceededError,
)
from itak.utilities.pydantic_schema_utils import generate_model_description
...
class OpenAICompletion(BaseLLM):
    ...
    def _prepare_completion_params(
        ...
        # Filter out iTaK-specific parameters that shouldn't go to the API
        iTaK_specific_params = {
            "callbacks",
            "available_functions",
            "from_task",
            "from_agent",
        ...
        return {k: v for k, v in params.items() if k not in iTaK_specific_params}

    def _convert_tools_for_interference(
        self, tools: list[dict[str, BaseTool]]
    ) -> list[dict[str, Any]]:
        """Convert iTaK tool format to OpenAI function calling format."""
        from itak.llms.providers.utils.common import safe_tool_conversion
    ...
    def get_context_window_size(self) -> int:
        ...
        from itak.llm import CONTEXT_WINDOW_USAGE_RATIO, LLM_CONTEXT_WINDOW_SIZES
