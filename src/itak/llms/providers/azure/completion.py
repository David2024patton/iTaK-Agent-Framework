...
try:
    ...
    raise ImportError(
        'Azure AI Inference native provider not available, to install: uv add "iTaK[azure-ai-inference]"'
    ) from None
...
class AzureCompletion(BaseLLM):
    ...
    def _convert_tools_for_interference(  # type: ignore[override]
        ...
        """Convert iTaK tool format to Azure OpenAI function calling format.

        Args:
            tools: List of iTaK tool definitions
