...
This module provides configuration for iTaK security features, including:
- Authentication settings
- Scoping rules
- Fingerprinting

The SecurityConfig class is the primary interface for managing security settings
in iTaK applications.
"""
...
class SecurityConfig(BaseModel):
    """
    Configuration for iTaK security features.

    This class manages security settings for iTaK agents, including:
