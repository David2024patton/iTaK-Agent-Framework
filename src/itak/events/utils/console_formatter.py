...
• Run: iTaK traces enable"""
    ...
    def handle_agent_logs_execution(
        ...
        from itak.agents.parser import AgentAction, AgentFinish
    ...
    def handle_a2a_response_received(
        ...
        iTaK_agent_role = self._pending_a2a_agent_role or agent_role or "User"
        ...
        if message_content:
            content.append(f"{iTaK_agent_role}: ", style="blue bold")
            msg_preview = (
                message_content[:200] + "..."
