...
from itak.cli.authentication.token import AuthError, get_auth_token
from itak.cli.version import get_iTaK_version
from itak.events.base_event_listener import BaseEventListener
from itak.events.event_bus import iTaKEventsBus
from itak.events.listeners.tracing.first_time_trace_handler import (
    FirstTimeTraceHandler,
)
from itak.events.listeners.tracing.trace_batch_manager import TraceBatchManager
from itak.events.listeners.tracing.types import TraceEvent
...
from itak.events.types.system_events import SignalEvent, on_signal
...
class TraceCollectionListener(BaseEventListener):
    ...
    def _get_user_context(self) -> dict[str, str]:
        ...
        return {
            "user_id": os.getenv("iTaK_USER_ID", "anonymous"),
            "organization_id": os.getenv("iTaK_ORG_ID", ""),
    ...
    def setup_listeners(self, iTaK_event_bus: iTaKEventsBus) -> None:
        ...
        self._register_flow_event_handlers(iTaK_event_bus)
        self._register_context_event_handlers(iTaK_event_bus)
        self._register_action_event_handlers(iTaK_event_bus)
        self._register_system_event_handlers(iTaK_event_bus)

        self._listeners_setup = True

    def _register_flow_event_handlers(self, event_bus: iTaKEventsBus) -> None:
    ...
    def _register_context_event_handlers(self, event_bus: iTaKEventsBus) -> None:
    ...
    def _register_action_event_handlers(self, event_bus: iTaKEventsBus) -> None:
    ...
    def _register_system_event_handlers(self, event_bus: iTaKEventsBus) -> None:
