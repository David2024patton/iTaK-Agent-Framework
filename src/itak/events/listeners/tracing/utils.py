...
from itak.utilities.serialization import to_serializable
...
def should_enable_tracing(*, override: bool | None = None) -> bool:
    ...
    2. Environment variable iTaK_TRACING_ENABLED
    ...
    env_value = os.getenv("iTaK_TRACING_ENABLED", "").lower()
...
def is_tracing_enabled() -> bool:
    ...
    return os.getenv("iTaK_TRACING_ENABLED", "false").lower() == "true"
...
def on_first_execution_tracing_confirmation() -> bool:
    ...
    if is_first_execution():
        ...
        return click.confirm(
            "This is the first execution of iTaK. Do you want to enable tracing?",
            default=True,
            show_default=True,
        )
    return False
...
def _is_test_environment() -> bool:
    ...
    return os.environ.get("iTaK_TESTING", "").lower() == "true"
