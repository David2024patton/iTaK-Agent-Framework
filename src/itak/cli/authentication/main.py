...
from itak.cli.authentication.utils import validate_jwt_token
...
if TYPE_CHECKING:
    from itak.cli.authentication.providers.base_provider import BaseProvider
...
class ProviderFactory:
    ...
    def from_settings(
        ...
        module = importlib.import_module(
            f"iTaK.cli.authentication.providers.{settings.provider.lower()}"
        )
...
class AuthenticationCommand:
    ...
    def login(self) -> None:
        """Sign up to iTaK+"""
        console.print("Signing in to iTaK AMP...\n", style="bold blue")
    ...
    def _poll_for_token(self, device_code_data: dict[str, Any]) -> None:
        ...
        while True and attempts < 10:
            ...
            if response.status_code == 200:
                ...
                console.print("\n[bold green]Welcome to iTaK AMP![/bold green]\n")
                return
    ...
    def _login_to_tool_repository(self) -> None:
        ...
        try:
            ...
            console.print(
                ...
                "\nRun [bold]iTaK login[/bold] to try logging in again.\n",
                style="yellow",
            )
