...
from itak.cli.constants import ENV_VARS
from itak.crew import Crew
from itak.flow import Flow
...
def _get_project_attribute(
    ...
    try:
        ...
        if not any(True for dep in dependencies if "iTaK" in dep):
            raise Exception("iTaK is not in the dependencies.")
...
def is_valid_tool(obj: Any) -> bool:
    from itak.tools.base_tool import Tool
...
def _print_no_tools_warning() -> None:
    ...
    console.print(
        ...
        "[green]from itak.tools import BaseTool, tool\n\n"
        "# Tool class example\n"
