...
def print_menu():
    ...
    print(f"    [{Theme.CYAN}2{RESET}] 💬 {Theme.CYAN}Chat{RESET}              {DIM}Natural, Wizard, or Guild{RESET}")
    print(f"    [{Theme.CYAN}3{RESET}] 🔮 {Theme.CYAN}Wizards{RESET}           {DIM}Build wizards and guilds{RESET}")
    print(f"    [{Theme.CYAN}4{RESET}] ⚡ {Theme.CYAN}Powers{RESET}            {DIM}Skills and capabilities{RESET}")
    print()
    print(f"    [{Theme.CYAN}5{RESET}] 🌐 {Theme.CYAN}API Gateway{RESET}       {DIM}FastAPI & tunnels{RESET}")
    print(f"    [{Theme.CYAN}6{RESET}] 🧩 {Theme.CYAN}Optional Services{RESET} {DIM}Supabase, ComfyUI, etc{RESET}")
    print()
