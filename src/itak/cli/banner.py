...
def print_menu():
    ...
    print(f"    [{Theme.CYAN}2{RESET}] 💬 {Theme.CYAN}Chat{RESET}              {DIM}Natural, Agent, or Crew{RESET}")
    print(f"    [{Theme.CYAN}3{RESET}] 🤖 {Theme.CYAN}AI Agents{RESET}         {DIM}Build agents and crews{RESET}")
    print()
    print(f"    [{Theme.CYAN}4{RESET}] ⚡ {Theme.CYAN}API Gateway{RESET}       {DIM}FastAPI & tunnels{RESET}")
    print(f"    [{Theme.CYAN}5{RESET}] 🧩 {Theme.CYAN}Optional Services{RESET} {DIM}Supabase, ComfyUI, etc{RESET}")
    print()
