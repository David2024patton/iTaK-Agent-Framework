...
def run_project_wizard(initial_prompt: str = None, project_type_idx: int = None):
    ...
    click.secho("  │                                                                      │", fg="bright_black")
    click.secho("  │    🌐 Web Apps    → React dashboards, landing pages, portfolios     │", fg="bright_black")
    click.secho("  │    🐍 Python      → Data scripts, web scrapers, automation          │", fg="bright_black")
    click.secho("  │    ⚡ APIs        → FastAPI backends, REST services, webhooks       │", fg="bright_black")
    click.secho("  │    🤖 AI Agents   → CrewAI workflows, chatbots, automation          │", fg="bright_black")
    click.secho("  │    📝 Custom      → Describe anything, AI figures out the rest      │", fg="bright_black")
    click.secho("  │                                                                      │", fg="bright_black")
    click.secho("  └──────────────────────────────────────────────────────────────────────┘", fg="bright_black")
    click.echo()
