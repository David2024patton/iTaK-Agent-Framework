...
{{folder_name}} is a itak Tool. This template is designed to help you create
...
```bash
itak tool publish {{tool_name}}
```

Others may install your tool in their crews running:

```bash
itak tool install {{tool_name}}
```

## Support

For support, questions, or feedback regarding the {{crew_name}} tool or itak.
