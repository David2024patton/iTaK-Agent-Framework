...
class OrganizationCommand(BaseCommand, PlusAPIMixin):
    ...
    def list(self):
        try:
            ...
            if e.response.status_code == 401:
                console.print(
                    "You are not logged in to any organization. Use 'iTaK login' to login.",
                    style="bold red",
                )
                return
            console.print(
    ...
    def current(self):
        ...
        if settings.org_uuid:
            ...
            console.print(
                "Use 'iTaK org list' to see available organizations.", style="yellow"
            )
            console.print(
                "Use 'iTaK org switch <id>' to switch to an organization.",
                style="yellow",
            )
