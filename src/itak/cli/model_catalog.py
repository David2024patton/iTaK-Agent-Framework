...
RECOMMENDED_MODELS = {
    ...
    "general": "ollama/qwen3:8b",
    "vision": "ollama/qwen3-vl:8b",
    "agent": "ollama/qwen2.5-coder-cline:7b",
    "lightweight": "ollama/smollm2:1.7b",
    "medical": "ollama/meditron:7b",
    "legal": "ollama/initium/law_model:Q5_0",
    "finance": "ollama/0xroyce/plutus:latest",
    "sql": "ollama/sqlcoder:7b",
    "math": "ollama/mathstral:7b",
    "writing": "ollama/mistral-nemo:12b",
    "roleplay": "ollama/dolphin3:8b",
    "embedding": "ollama/nomic-embed-text-v2-moe:latest",
    "security": "ollama/llama-guard3:8b",
    "science": "ollama/solar:10.7b",
    "education": "ollama/orca2:7b",
    "translation": "ollama/aya:8b",
    "extraction": "ollama/nuextract:3.8b",
}
