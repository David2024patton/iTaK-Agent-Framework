...
from itak.cli.constants import DEFAULT_iTaK_ENTERPRISE_URL
from itak.cli.version import get_iTaK_version


class PlusAPI:
    """
    This class exposes methods for working with the iTaK+ API.
    """

    TOOLS_RESOURCE = "/iTaK_plus/api/v1/tools"
    ORGANIZATIONS_RESOURCE = "/iTaK_plus/api/v1/me/organizations"
    CREWS_RESOURCE = "/iTaK_plus/api/v1/crews"
    AGENTS_RESOURCE = "/iTaK_plus/api/v1/agents"
    TRACING_RESOURCE = "/iTaK_plus/api/v1/tracing"
    EPHEMERAL_TRACING_RESOURCE = "/iTaK_plus/api/v1/tracing/ephemeral"
    INTEGRATIONS_RESOURCE = "/iTaK_plus/api/v1/integrations"
    ...
    def __init__(self, api_key: str) -> None:
        ...
        self.headers = {
            ...
            "User-Agent": f"iTaK-CLI/{get_iTaK_version()}",
            "X-iTaK-Version": get_iTaK_version(),
        }
        settings = Settings()
        if settings.org_uuid:
            self.headers["X-iTaK-Organization-Id"] = settings.org_uuid

        self.base_url = os.getenv("iTaK_PLUS_URL") or str(settings.enterprise_base_url) or DEFAULT_iTaK_ENTERPRISE_URL
