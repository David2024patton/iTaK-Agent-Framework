...
from itak.cli.utils import fetch_and_json_env_file, get_project_name
...
class DeployCommand(BaseCommand, PlusAPIMixin):
    """
    A class to handle deployment-related operations for iTaK projects.
    """
    ...
    def _display_deployment_info(self, json_response: dict[str, Any]) -> None:
        ...
        console.print("iTaK deploy status")
        console.print(" or")
        console.print(f'iTaK deploy status --uuid "{json_response["uuid"]}"')
    ...
    def _display_creation_success(self, json_response: dict[str, Any]) -> None:
        ...
        console.print("iTaK deploy push")
        console.print(" or")
        console.print(f"iTaK deploy push --uuid {json_response['uuid']}")
    ...
    def _display_no_crews_message(self) -> None:
        ...
        console.print("  iTaK create crew <crew_name>", style="green")
