...
from itak.project.wrappers import CrewClass, CrewMetadata
...
if TYPE_CHECKING:
    ...
    from itak.project.wrappers import (
        CrewInstance,
        OutputJsonClass,
        OutputPydanticClass,
    )
...
class TaskConfig(TypedDict, total=False):
    ...
    # Misc configuration
    allow_iTaK_trigger_context: bool
...
def get_mcp_tools(self: CrewInstance, *tool_names: str) -> list[BaseTool]:
    ...
    from itak_tools import MCPServerAdapter
