...
from itak.a2a.types import TransportType, Url
...
try:
    ...
    from itak.a2a.updates import UpdateConfig
except ImportError:
    UpdateConfig = Any
...
def _get_default_update_config() -> UpdateConfig:
    from itak.a2a.updates import StreamingConfig
...
@deprecated(
    """
    `iTaK.a2a.config.A2AConfig` is deprecated and will be removed in v2.0.0,
    use `iTaK.a2a.config.A2AClientConfig` or `iTaK.a2a.config.A2AServerConfig` instead.
    """,
