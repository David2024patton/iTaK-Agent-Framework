...
from itak.a2a.config import A2AClientConfig, A2AConfig
from itak.a2a.extensions.base import ExtensionRegistry
from itak.a2a.task_helpers import TaskStateResult
from itak.a2a.templates import (
...
from itak.a2a.types import AgentResponseProtocol
from itak.a2a.utils.agent_card import (
    afetch_agent_card,
    fetch_agent_card,
    inject_a2a_server_methods,
)
from itak.a2a.utils.delegation import (
    aexecute_a2a_delegation,
    execute_a2a_delegation,
)
from itak.a2a.utils.response_model import get_a2a_agents_and_response_model
...
def _handle_agent_response_and_continue(
    ...
    """Handle A2A result and get iTaK agent's response.
...
def _delegate_to_a2a(
    ...
    try:
        for turn_num in range(max_turns):
            console_formatter = getattr(iTaK_event_bus, "_console", None)
            agent_branch = None
