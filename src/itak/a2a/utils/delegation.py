...
from itak.a2a.auth.schemas import APIKeyAuth, HTTPDigestAuth
from itak.a2a.auth.utils import (
    _auth_store,
    configure_auth_client,
    validate_auth_against_agent_card,
)
from itak.a2a.task_helpers import TaskStateResult
from itak.a2a.types import (
    HANDLER_REGISTRY,
    HandlerType,
    PartsDict,
    PartsMetadataDict,
)
from itak.a2a.updates import (
    PollingConfig,
    PushNotificationConfig,
    StreamingHandler,
    UpdateConfig,
)
from itak.a2a.utils.agent_card import _afetch_agent_card_cached
...
if TYPE_CHECKING:
    ...
    from itak.a2a.auth.schemas import AuthScheme
...
def execute_a2a_delegation(
    ...
    Args:
        ...
        agent_role: Role of the iTaK agent delegating the task
