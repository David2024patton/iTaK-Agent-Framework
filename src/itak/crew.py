...
from itak.agent import Agent
from itak.agents.agent_builder.base_agent import BaseAgent
from itak.agents.cache.cache_handler import CacheHandler
from itak.crews.crew_output import CrewOutput
from itak.crews.utils import (
    StreamingContext,
...
from itak.events.event_bus import iTaK_event_bus
from itak.events.event_listener import EventListener
from itak.events.listeners.tracing.trace_listener import (
...
from itak.flow.flow_trackable import FlowTrackable
from itak.knowledge.knowledge import Knowledge
from itak.knowledge.source.base_knowledge_source import BaseKnowledgeSource
from itak.llm import LLM
from itak.llms.base_llm import BaseLLM
from itak.memory.entity.entity_memory import EntityMemory
from itak.memory.external.external_memory import ExternalMemory
from itak.memory.long_term.long_term_memory import LongTermMemory
from itak.memory.short_term.short_term_memory import ShortTermMemory
from itak.process import Process
from itak.rag.embeddings.types import EmbedderConfig
from itak.rag.types import SearchResult
...
from itak.tasks.conditional_task import ConditionalTask
from itak.tasks.task_output import TaskOutput
from itak.tools.agent_tools.agent_tools import AgentTools
from itak.tools.base_tool import BaseTool
from itak.types.streaming import CrewStreamingOutput
from itak.types.usage_metrics import UsageMetrics
from itak.utilities.constants import NOT_SPECIFIED, TRAINING_DATA_FILE
from itak.utilities.crew.models import CrewContext
from itak.utilities.evaluators.crew_evaluator_handler import CrewEvaluator
from itak.utilities.evaluators.task_evaluator import TaskEvaluator
from itak.utilities.file_handler import FileHandler
from itak.utilities.formatter import (
    aggregate_raw_outputs_from_task_outputs,
    aggregate_raw_outputs_from_tasks,
)
from itak.utilities.i18n import get_i18n
from itak.utilities.llm_utils import create_llm
from itak.utilities.logger import Logger
from itak.utilities.planning_handler import CrewPlanner
from itak.utilities.printer import PrinterColor
from itak.utilities.rpm_controller import RPMController
from itak.utilities.streaming import (
    create_async_chunk_generator,
    create_chunk_generator,
    signal_end,
    signal_error,
)
from itak.utilities.task_output_storage_handler import TaskOutputStorageHandler
from itak.utilities.training_handler import CrewTrainingHandler
...
class Crew(FlowTrackable, BaseModel):
    ...
    Attributes:
        ...
        share_crew: Whether you want to share the complete crew information and
            execution with iTaK to make the library better, and allow us to
            train models.
    ...
    def set_private_attrs(self) -> Crew:
        ...
        trace_listener.setup_listeners(iTaK_event_bus)
    ...
    def _set_allow_iTaK_trigger_context_for_first_task(self) -> None:
        iTaK_trigger_payload = self._inputs and self._inputs.get(
            "iTaK_trigger_payload"
        )
        able_to_inject = (
            self.tasks and self.tasks[0].allow_iTaK_trigger_context is None
        )

        if (
            self.process == Process.sequential
            and iTaK_trigger_payload
            and able_to_inject
        ):
            self.tasks[0].allow_iTaK_trigger_context = True

    @staticmethod
    def _show_tracing_disabled_message() -> None:
        """Show a message when tracing is disabled."""
        from itak.events.listeners.tracing.utils import has_user_declined_tracing
...
• Set iTaK_TRACING_ENABLED=true in your project's .env file
• Run: iTaK traces enable"""
        else:
            message = """Info: Tracing is disabled.
