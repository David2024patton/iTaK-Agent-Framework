...
from itak.memory.external.external_memory_item import ExternalMemoryItem
from itak.memory.memory import Memory
from itak.memory.storage.interface import Storage
from itak.rag.embeddings.types import ProviderSpec


if TYPE_CHECKING:
    from itak.memory.storage.mem0_storage import Mem0Storage
