...
from itak_tools.rag.base_loader import BaseLoader
from itak_tools.rag.chunkers.base_chunker import BaseChunker
from itak_tools.rag.data_types import DataType
from itak_tools.rag.embedding_service import EmbeddingService
from itak_tools.rag.misc import compute_sha256
...
class RAG(Adapter):
    collection_name: str = "iTaK_knowledge_base"
    ...
    def model_post_init(self, __context: Any) -> None:
        try:
            ...
            self._collection = self._client.get_or_create_collection(
                ...
                metadata={
                    "hnsw:space": "cosine",
                    "description": "iTaK Knowledge Base",
                },
            )
