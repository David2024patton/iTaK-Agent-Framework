"""
Enhanced embedding service that leverages iTaK's existing embedding providers.
...
class EmbeddingService:
    """
    Enhanced embedding service that uses iTaK's existing embedding providers.
    ...
    def _initialize_embedding_function(self):
        """Initialize the embedding function using iTaK's factory."""
        try:
            from itak.rag.embeddings.factory import build_embedder

            # Build the configuration for iTaK's factory
            ...
            raise ImportError(
                f"iTaK embedding providers not available. "
                f"Make sure iTaK is installed: {e}"
            ) from e
    ...
    def _build_provider_config(self) -> dict[str, Any]:
        """Build configuration dictionary for iTaK's embedding factory."""
