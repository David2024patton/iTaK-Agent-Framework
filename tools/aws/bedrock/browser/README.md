...
This toolkit provides a set of tools for interacting with web browsers through AWS Bedrock Browser. It enables your itak agents to navigate websites, extract content, click elements, and more.
...
```bash
uv add itak-tools bedrock-agentcore beautifulsoup4 playwright nest-asyncio
```
...
from itak_tools.aws.bedrock.browser import create_browser_toolkit
...
# Create a itak agent that uses the browser tools
