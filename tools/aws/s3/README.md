...
Install the itak_tools package
...
To use the AWS S3 tools in your itak agents, import the necessary tools and include them in your agent's configuration:

```python
from itak_tools.aws.s3 import S3ReaderTool, S3WriterTool
...
These tools can be used to read from and write to S3 buckets within your itak workflows. Make sure you have properly configured your AWS credentials as mentioned in the AWS Connectivity section above.
