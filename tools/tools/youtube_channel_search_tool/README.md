...
## Installation
To utilize the YoutubeChannelSearchTool, the `itak_tools` package must be installed. Execute the following command in your shell to install:
...
```python
from itak_tools import YoutubeChannelSearchTool
