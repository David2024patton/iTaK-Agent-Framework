...
from itak_tools.tools.mongodb_vector_search_tool.utils import (
...
class MongoDBVectorSearchTool(BaseTool):
    ...
    def __init__(self, **kwargs):
        ...
        if not MONGODB_AVAILABLE:
            ...
            if click.confirm(
                "You are missing the 'mongodb' iTaK tool. Would you like to install it?"
            ):
                import subprocess
                ...
                raise ImportError("You are missing the 'mongodb' iTaK tool.")
        ...
        self._client = MongoClient(
            ...
            driver=DriverInfo(name="iTaK", version=version("iTaK-tools")),
        )
