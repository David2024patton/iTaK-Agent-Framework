...
Install the itak_tools package with the databricks extra:

```shell
pip install 'itak[tools]' 'databricks-sdk'
```
...
```python
from itak_tools import DatabricksQueryTool
