...
## Installation
To start using the DirectorySearchTool, you need to install the itak_tools package. Execute the following command in your terminal:
...
```python
from itak_tools import DirectorySearchTool
