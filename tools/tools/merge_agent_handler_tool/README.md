...
### Step 2: Install itak Tools

To incorporate this tool into your project, install itak with tools support:
...
The following example demonstrates how to initialize a specific tool and use it with a itak agent:

```python
from itak_tools import MergeAgentHandlerTool
from itak import Agent, Task
