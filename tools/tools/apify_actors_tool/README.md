...
Integrate [Apify Actors](https://apify.com/actors) into your itak workflows.

## Description

The `ApifyActorsTool` connects [Apify Actors](https://apify.com/actors), cloud-based programs for web scraping and automation, to your itak workflows.
...
For details, see the [Apify itak integration](https://docs.apify.com/platform/integrations/itak) in Apify documentation.
...
1. **Install dependencies**
   Install `itak[tools]` and `langchain-apify`:
   ```bash
   pip install 'itak[tools]' langchain-apify
   ```
...
```python
from itak_tools import ApifyActorsTool

# Initialize the tool with an Apify Actor
tool = ApifyActorsTool(actor_name="apify/rag-web-browser")

# Run the tool with input parameters
results = tool.run(run_input={"query": "What is itak?", "maxResults": 5})
...
```text
URL: https://www.example.com/itak-intro
Content: itak is a framework for building AI-powered workflows...
URL: https://docs.itak.com/
Content: Official documentation for itak...
```
...
For an example of usage with agents, see the [itak Actor template](https://apify.com/templates/python-itak).
...
- **[itak Integration Guide](https://docs.apify.com/platform/integrations/itak)**: Follow the official guide for integrating Apify and itak.
