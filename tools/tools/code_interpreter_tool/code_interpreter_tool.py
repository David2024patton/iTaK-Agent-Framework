...
from itak_tools.printer import Printer
...
class CodeInterpreterTool(BaseTool):
    ...
    def _get_installed_package_path() -> str:
        """Gets the installation path of the itak_tools package.
        ...
        """
        spec = importlib.util.find_spec("itak_tools")
        if spec is None or spec.origin is None:
            raise RuntimeError("Cannot find itak_tools package installation path")
