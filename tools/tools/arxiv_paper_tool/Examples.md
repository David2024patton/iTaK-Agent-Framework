### Example 1: Fetching Research Papers from arXiv with itak

This example demonstrates how to build a simple itak workflow that automatically searches for and downloads academic papers from [arXiv.org](https://arxiv.org). The setup uses:
...
```
from itak import Agent, Task, Crew, Process, LLM
from itak_tools import ArxivPaperTool 
