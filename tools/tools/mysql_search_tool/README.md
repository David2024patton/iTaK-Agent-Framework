...
## Installation
To install the `itak_tools` package and utilize the MySQLSearchTool, execute the following command in your terminal:
...
```python
from itak_tools import MySQLSearchTool
