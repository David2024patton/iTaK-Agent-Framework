...
## Installation
To start using the SerpApi Tools, you must first install the `itak_tools` package. This can be easily done with the following command:
...
### Google Search
```python
from itak_tools import SerpApiGoogleSearchTool
...
### Google Shopping
```python
from itak_tools import SerpApiGoogleShoppingTool
