...
class InvokeiTaKAutomationInput(BaseModel):
    """Input schema for InvokeiTaKAutomationTool."""

    prompt: str = Field(..., description="The prompt or query to send to the crew")


class InvokeiTaKAutomationTool(BaseTool):
    """A iTaK tool for invoking external crew/flows APIs.

    This tool provides iTaK Platform API integration with external crew services, supporting:
    ...
    Example:
        ...
        ...         crew_api_url="https://canary-crew-[...].iTaK.com",
    ...
    description: str = "Invokes an iTaK Platform Automation using API"
    args_schema: type[BaseModel] = InvokeiTaKAutomationInput
    ...
    def __init__(
        ...
        """Initialize the InvokeiTaKAutomationTool.
        ...
        if crew_inputs:
            ...
            args_schema = create_model("DynamicInvokeiTaKAutomationInput", **fields)  # type: ignore[call-overload]
        else:
            args_schema = InvokeiTaKAutomationInput
