...
The InvokeitakAutomationTool provides itak Platform API integration with external crew services. This tool allows you to invoke and interact with itak Platform automations from within your itak agents, enabling seamless integration between different crew workflows.
...
```python
from itak_tools import InvokeitakAutomationTool

# Basic crew automation tool
tool = InvokeitakAutomationTool(
    crew_api_url="https://data-analysis-crew-[...].itak.com",
...
tool = InvokeitakAutomationTool(
    crew_api_url="https://state-of-ai-report-crew-[...].itak.com",
    crew_bearer_token="your_bearer_token_here",
...
market_research_tool = InvokeitakAutomationTool(
    crew_api_url="https://market-research-automation-crew-[...].itak.com",
    crew_bearer_token="your_bearer_token_here",
...
- `crew_api_url` (str): Base URL of the itak Platform automation API
