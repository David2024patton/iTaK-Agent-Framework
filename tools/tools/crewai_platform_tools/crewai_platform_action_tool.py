...
from itak_tools.tools.iTaK_platform_tools.misc import (
...
class iTaKPlatformActionTool(BaseTool):
    ...
    def _run(self, **kwargs) -> str:
        try:
            ...
            response = requests.post(
                ...
                json=payload,
                timeout=60,
                verify=os.environ.get("iTaK_FACTORY", "false").lower() != "true",
            )
