...
## Installation
To install the `itak_tools` package with SingleStore support, execute the following command:
...
```python
from itak_tools import SingleStoreSearchTool
...
## Complete itak Integration Example

Here's a complete example showing how to use the SingleStoreSearchTool with itak agents and tasks:
...
### Advanced itak Example with Multiple Agents
