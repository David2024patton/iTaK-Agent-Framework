...
This tool integrates the [Stagehand](https://docs.stagehand.dev/) framework with itak, allowing agents to interact with websites and automate browser tasks using natural language instructions.
...
The StagehandTool wraps the Stagehand Python SDK to provide itak agents with the ability to control a real web browser and interact with websites using three core primitives:
...
from itak_tools import StagehandTool
...
For questions about the itak integration, join our [Slack](https://stagehand.dev/slack) or open an issue in this repository.