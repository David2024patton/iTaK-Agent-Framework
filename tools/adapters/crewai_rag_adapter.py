"""Adapter for iTaK's native RAG system."""
...
from itak.rag.config.types import RagConfigType
from itak.rag.config.utils import get_rag_client
from itak.rag.core.base_client import BaseClient
from itak.rag.factory import create_client
from itak.rag.types import BaseRecord, SearchResult
from pydantic import PrivateAttr
from pydantic.dataclasses import is_pydantic_dataclass
from typing_extensions import TypeIs, Unpack

from itak_tools.rag.data_types import DataType
from itak_tools.rag.misc import sanitize_metadata_for_chromadb
from itak_tools.tools.rag.rag_tool import Adapter
from itak_tools.tools.rag.types import AddDocumentParams, ContentItem
...
class iTaKRagAdapter(Adapter):
    """Adapter that uses iTaK's native RAG system.
    ...
    def model_post_init(self, __context: Any) -> None:
        """Initialize the iTaK RAG client after model initialization."""
    ...
    def add(self, *args: ContentItem, **kwargs: Unpack[AddDocumentParams]) -> None:
        ...
        from itak_tools.rag.base_loader import LoaderResult
        from itak_tools.rag.data_types import DataType, DataTypes
        from itak_tools.rag.source_content import SourceContent
