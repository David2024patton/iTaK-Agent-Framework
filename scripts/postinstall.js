...
# Auto-generated by npm install | Platform: ${PLATFORM}

# Default LLM Model
ITAK_DEFAULT_MODEL=${DEFAULT_MODEL}

# ═══════════════════════════════════════════════════════════════════
# LOCAL SERVICE URLs (Direct Access)
# ═══════════════════════════════════════════════════════════════════
`;
    ...
    // Add FastAPI endpoints section
    content += `
# ═══════════════════════════════════════════════════════════════════
# FASTAPI GATEWAY ENDPOINTS (via API Gateway at :${API_GATEWAY_PORT})
# ═══════════════════════════════════════════════════════════════════
# These endpoints proxy through the API Gateway for unified access:
#
# /api/ollama/*     → Ollama LLM (generate, chat, embeddings)
# /api/chromadb/*   → ChromaDB vector database
# /api/playwright/* → Playwright browser automation
# /api/search/*     → SearXNG private search
# /health           → Gateway health check
#
# Example: curl http://localhost:${API_GATEWAY_PORT}/health
# ═══════════════════════════════════════════════════════════════════
`;
